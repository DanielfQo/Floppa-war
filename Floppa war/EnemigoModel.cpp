...
EnemigoModel::EnemigoModel(float pX_, float pY_, float Vida_, float Ataque_, float Escudo_, float width_, float height_, float vel_) : EntidadModel(pX_, pY_, Vida_, Ataque_, Escudo_, width_, height_, vel_) {}
...
MeleeEnemigoModel::MeleeEnemigoModel(): EnemigoModel(0.00f, 0.00f, 100, 0.02, 50, 64 , 64, 2){}
